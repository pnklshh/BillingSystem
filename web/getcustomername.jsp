...
<!--              <li><a href="showlastorderid.jsp">Show last order id</a></li>-->
        ...
        <div class="row">
            <form action="showmyorderid.jsp" method="GET" class="col s12 center-align">
            
            <div class="row">
            <div class="input-field col s4 offset-s4">
                <input name="customer" placeholder="Customer name or Customer id" value="" id="customer" type="text" class="active validate" required>
            </div>    
            </div> 
         ...
         <!--   <div class="row">
            ...
            <div class="row">
                <button class="btn waves-effect waves-light red" type="submit">Show</button>
            </div>
